...
Great! You installed git on your computer :) Now time to create a Git account by following the instructions on this page: https://docs.github.com/en/get-started/signing-up-for-github/signing-up-for-a-new-github-account
After you have a username and password for git, let's clone this repository to our local machine by executing the command below.
